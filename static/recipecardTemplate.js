...
templates['recipecardTemplate'] = template({"compiler":[8,">= 4.3.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "<div class=\"recipe-card\" name=\""
    ...
    + alias4(((helper = (helper = lookupProperty(helpers,"link-to-recipe") || (depth0 != null ? lookupProperty(depth0,"link-to-recipe") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"link-to-recipe","hash":{},"data":data,"loc":{"start":{"line":6,"column":37},"end":{"line":6,"column":55}}}) : helper)))
    + "\" target=\"_blank\">\n        <h2>"
